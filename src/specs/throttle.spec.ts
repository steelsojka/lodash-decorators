...
import {
  ...
  ThrottleSetter as _ThrottleSetter,
  ThrottleGetter as _ThrottleGetter
} from '../legacy/throttle';
import { specFactory } from './specFactory';

export default specFactory<
  typeof _Throttle,
  typeof _ThrottleGetter,
  typeof _ThrottleSetter
>('throttle', (Throttle, ThrottleGetter, ThrottleSetter) => {
